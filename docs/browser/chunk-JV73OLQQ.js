...
// projects/ui-lib/src/lib/shared/types.ts
var BUTTON_SIZES = {
...
function ButtonComponent_span_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-label", ctx_r0.iconLeft);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.iconLeft, " ");
  }
}
function ButtonComponent_span_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275attribute("aria-label", ctx_r0.iconRight);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.iconRight, " ");
  }
}
var ButtonComponent = class _ButtonComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ButtonComponent, selectors: [["ui-button"]], hostVars: 1, hostBindings: function ButtonComponent_HostBindings(rf, ctx) {
    if (rf & 2) {
      \u0275\u0275attribute("disabled", ctx.isDisabled);
    }
  }, inputs: { variant: "variant", size: "size", disabled: "disabled", loading: "loading", iconLeft: "iconLeft", iconRight: "iconRight" }, outputs: { clicked: "clicked" }, standalone: true, features: [\u0275\u0275StandaloneFeature], ngContentSelectors: _c0, decls: 6, vars: 14, consts: [[3, "click", "keydown", "ngClass", "disabled"], ["class", "ui-button__spinner", "aria-hidden", "true", 4, "ngIf"], ["class", "ui-button__icon ui-button__icon--left", "aria-hidden", "true", "role", "img", 4, "ngIf"], [1, "ui-button__content"], ["class", "ui-button__icon ui-button__icon--right", "aria-hidden", "true", "role", "img", 4, "ngIf"], ["aria-hidden", "true", 1, "ui-button__spinner"], ["viewBox", "0 0 24 24", "fill", "none", 1, "ui-button__spinner-icon"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "3", "stroke-linecap", "round", "stroke-dasharray", "31.4 31.4"], ["aria-hidden", "true", "role", "img", 1, "ui-button__icon", "ui-button__icon--left"], ["aria-hidden", "true", "role", "img", 1, "ui-button__icon", "ui-button__icon--right"]], template: function ButtonComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      \u0275\u0275elementStart(0, "button", 0);
      \u0275\u0275listener("click", function ButtonComponent_Template_button_click_0_listener($event) {
        return ctx.onClick($event);
      })("keydown", function ButtonComponent_Template_button_keydown_0_listener($event) {
        return ctx.onKeyDown($event);
      });
      \u0275\u0275template(1, ButtonComponent_span_1_Template, 3, 0, "span", 1)(2, ButtonComponent_span_2_Template, 2, 2, "span", 2);
      \u0275\u0275elementStart(3, "span", 3);
      \u0275\u0275projection(4);
      \u0275\u0275elementEnd();
      \u0275\u0275template(5, ButtonComponent_span_5_Template, 2, 2, "span", 4);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275styleProp("padding", ctx.paddingStyle)("font-size", ctx.fontSizeStyle);
      \u0275\u0275property("ngClass", ctx.buttonClasses)("disabled", ctx.disabled || ctx.loading);
      \u0275\u0275attribute("aria-disabled", ctx.disabled || ctx.loading)("aria-busy", ctx.loading)("tabindex", ctx.disabled ? -1 : 0);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.loading);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.iconLeft);
      \u0275\u0275advance();
      \u0275\u0275classProp("ui-button__content--hidden", ctx.loading);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.iconRight);
    }
  }, dependencies: [CommonModule, NgClass, NgIf], styles: ['\n\n.ui-button[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  gap: var(--spacing-2, 8px);\n  font-family: var(--font-family, "Inter", sans-serif);\n  font-weight: var(--font-weight-medium, 500);\n  line-height: var(--line-height-tight, 1.25);\n  border-radius: var(--radius-md, 6px);\n  border: 1px solid transparent;\n  cursor: pointer;\n  transition: all var(--transition-fast, 150ms ease);\n  position: relative;\n  white-space: nowrap;\n  -webkit-user-select: none;\n  user-select: none;\n}\n.ui-button[_ngcontent-%COMP%]:focus-visible {\n  outline: 2px solid var(--color-focus-ring, rgba(59, 130, 246, 0.5));\n  outline-offset: 2px;\n}\n.ui-button--primary[_ngcontent-%COMP%] {\n  background-color: var(--color-primary, #3b82f6);\n  color: #ffffff;\n  border-color: var(--color-primary, #3b82f6);\n}\n.ui-button--primary[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background-color: color-mix(in srgb, var(--color-primary, #3b82f6) 85%, black);\n  border-color: color-mix(in srgb, var(--color-primary, #3b82f6) 85%, black);\n}\n.ui-button--primary[_ngcontent-%COMP%]:active:not(:disabled) {\n  background-color: color-mix(in srgb, var(--color-primary, #3b82f6) 75%, black);\n}\n.ui-button--secondary[_ngcontent-%COMP%] {\n  background-color: var(--color-secondary, #6b7280);\n  color: #ffffff;\n  border-color: var(--color-secondary, #6b7280);\n}\n.ui-button--secondary[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background-color: color-mix(in srgb, var(--color-secondary, #6b7280) 85%, black);\n  border-color: color-mix(in srgb, var(--color-secondary, #6b7280) 85%, black);\n}\n.ui-button--secondary[_ngcontent-%COMP%]:active:not(:disabled) {\n  background-color: color-mix(in srgb, var(--color-secondary, #6b7280) 75%, black);\n}\n.ui-button--outline[_ngcontent-%COMP%] {\n  background-color: transparent;\n  color: var(--color-primary, #3b82f6);\n  border-color: var(--color-border, #d1d5db);\n}\n.ui-button--outline[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background-color: var(--color-hover, rgba(0, 0, 0, 0.05));\n  border-color: var(--color-primary, #3b82f6);\n}\n.ui-button--outline[_ngcontent-%COMP%]:active:not(:disabled) {\n  background-color: var(--color-hover, rgba(0, 0, 0, 0.1));\n}\n.ui-button--sm[_ngcontent-%COMP%] {\n  min-height: 28px;\n}\n.ui-button--md[_ngcontent-%COMP%] {\n  min-height: 36px;\n}\n.ui-button--lg[_ngcontent-%COMP%] {\n  min-height: 44px;\n}\n.ui-button--disabled[_ngcontent-%COMP%], \n.ui-button[_ngcontent-%COMP%]:disabled {\n  opacity: 0.6;\n  cursor: not-allowed;\n  pointer-events: none;\n}\n.ui-button--loading[_ngcontent-%COMP%] {\n  cursor: wait;\n  pointer-events: none;\n}\n.ui-button__spinner[_ngcontent-%COMP%] {\n  position: absolute;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.ui-button__spinner-icon[_ngcontent-%COMP%] {\n  width: 1em;\n  height: 1em;\n  animation: _ngcontent-%COMP%_ui-button-spin 1s linear infinite;\n}\n@keyframes _ngcontent-%COMP%_ui-button-spin {\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n}\n.ui-button__content--hidden[_ngcontent-%COMP%] {\n  visibility: hidden;\n}\n.ui-button__icon[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  flex-shrink: 0;\n}\n.ui-button__icon--left[_ngcontent-%COMP%] {\n  order: -1;\n}\n.ui-button__icon--right[_ngcontent-%COMP%] {\n  order: 1;\n}\n.ui-button--icon-only[_ngcontent-%COMP%] {\n  aspect-ratio: 1;\n  min-width: auto;\n}\n.ui-button__content[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n}\n/*# sourceMappingURL=button.component.css.map */'], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ButtonComponent, { className: "ButtonComponent", filePath: "projects\\ui-lib\\src\\lib\\button\\button.component.ts", lineNumber: 28 });
})();
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JV73OLQQ.js.map
