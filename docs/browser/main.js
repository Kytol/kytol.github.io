...
var AppComponent = class _AppComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 13, vars: 0, consts: [[1, "app-shell"], [1, "main-nav"], [1, "nav-brand"], [1, "nav-links"], ["routerLink", "/ui-demo", "routerLinkActive", "active"], ["routerLink", "/goblin-tasks", "routerLinkActive", "active"], ["routerLink", "/raid-squad", "routerLinkActive", "active"], [1, "main-content"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "nav", 1)(2, "div", 2);
      \u0275\u0275text(3, "\u{1F383} Goblin Realm");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 3)(5, "a", 4);
      \u0275\u0275text(6, "\u{1F4E6} UI Demo");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "a", 5);
      \u0275\u0275text(8, "\u{1F9CC} Goblin Tasks");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "a", 6);
      \u0275\u0275text(10, "\u2694\uFE0F Raid Squad");
      \u0275\u0275elementEnd()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "src\\app\\app.component.ts", lineNumber: 70 });
})();

// src/app/app.routes.ts
var routes = [
  { path: "", redirectTo: "ui-demo", pathMatch: "full" },
  { path: "ui-demo", loadComponent: () => import("./chunk-HQJTMPDG.js").then((m) => m.UiDemoComponent) },
  { path: "goblin-tasks", loadComponent: () => import("./chunk-CEFJF6NV.js").then((m) => m.GoblinTasksViewComponent) },
  { path: "raid-squad", loadComponent: () => import("./chunk-DEJBWYDH.js").then((m) => m.RaidSquadViewComponent) },
